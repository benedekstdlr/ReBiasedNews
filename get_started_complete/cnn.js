...
request.onload = function() {
    if(this.response === undefined || this.response.length == 0) {
        ...
        console.log(resp);
        content.innerHTML = firstpar.innerHTML + '<p class="zn-body__paragraph">' + resp +'</p>'+ '<p class="zn-body__paragraph zn-body__footer"> This article was generated by a ROBOT</p>';
    }
};
